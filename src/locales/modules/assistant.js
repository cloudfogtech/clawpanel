...
export default {
  ...
  toolMedia: _('媒体生成', 'Media generation', '媒體生成', 'メディア生成', '미디어 생성', 'Tạo media', 'Generación multimedia', 'Geração de mídia', 'Генерация медиа', 'Génération média', 'Mediengenerierung'),
  toolMediaDesc: _('调用媒体中心生成图片和视频', 'Use Media Center to generate images and videos', '調用媒體中心生成圖片和影片', 'メディアセンターで画像と動画を生成', '미디어 센터로 이미지와 비디오 생성', 'Dùng Media Center để tạo ảnh và video'),
  toolMediaConfig: _('媒体配置', 'Media config', '媒體設定'),
  toolGenerateImage: _('生成图片', 'Generate image', '生成圖片'),
  toolCreateVideo: _('创建视频任务', 'Create video task', '建立影片任務'),
  toolPollVideo: _('轮询视频任务', 'Poll video task', '輪詢影片任務'),
  toolListMediaJobs: _('媒体历史', 'Media history', '媒體歷史'),
  ...
  confirmGenerateImage: _('将调用媒体中心生成图片，可能产生服务商费用', 'Will generate images via Media Center and may incur provider charges', '將調用媒體中心生成圖片，可能產生服務商費用'),
  confirmCreateVideo: _('将调用媒体中心创建视频任务，可能产生服务商费用', 'Will create a video task via Media Center and may incur provider charges', '將調用媒體中心建立影片任務，可能產生服務商費用'),
